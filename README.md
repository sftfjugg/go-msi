...
This tool is part of the [go-github-release workflow](https://github.com/sftfjugg/go-github-release)

Find a demo program [here](https://go-msi/tree/master/testing/hello)
...
Check the [release page](https://go-msi/releases)!
...
- A windows machine (see [here](https://go-msi/blob/master/appveyor-recipe.md) for an appveyor file, see [here](https://go-msi/blob/master/unice-recipe.md) for unix friendly users)
...
- Create a `wix.json` file like [this one](https://go-msi/blob/master/wix.json)
...
[Check the demo json file](https://go-msi/blob/master/testing/hello/wix.json)
...
For simplicity a default install flow is provided, which you can find [here](https://go-msi/tree/master/templates)
...
Please check [this](https://go-msi/blob/master/appveyor-recipe.md)

### Unix like

Please check [this](https://go-msi/blob/master/unice-recipe.md)
